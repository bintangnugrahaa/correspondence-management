...
function displayAgendaReport()
{
    ...
    $suratData = getSuratMasukByDateRange($dari_tanggal, $sampai_tanggal);
...
/**
 * Get surat masuk data by date range
 */
function getSuratMasukByDateRange($dari_tanggal, $sampai_tanggal)
{
    global $config;
    ...
    return mysqli_query(
        $config,
        "SELECT sm.*, u.nama as penerima 
         FROM tbl_surat_masuk sm 
         LEFT JOIN tbl_user u ON sm.id_user = u.id_user 
         WHERE sm.tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' 
         ORDER BY sm.tgl_diterima"
    );
}
                        ...
                        <div class="col 12">
                            <ul class="left">
                                <li class="waves-effect waves-light">
                                    <a href="?page=asm" class="judul">
                                        <i class="material-icons">print</i> Cetak Agenda Surat Masuk
                                    </a>
                                </li>
                            </ul>
                        </div>
...
function getReportHeader($instansiData, $dari_tanggal, $sampai_tanggal)
{
    ...
    <div class="row agenda">
        ...
        <h5 class="visible-print">AGENDA SURAT MASUK</h5>
        <div class="col s10">
            <p class="agenda-info">
                Agenda Surat Masuk dari tanggal 
