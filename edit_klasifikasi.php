                        ...
                        <form class="col s12" method="post" action="?page=ref&act=edit">
                            ...
                            <div class="row">
                                <div class="input-field col s3">
                                    ...
                                    <input id="kd" type="text" class="validate" name="kode" maxlength="30"
                                        value="<?php echo $row['kode']; ?>" required>
                                    <?php
                                ...
                                <div class="input-field col s12">
                                    ...
                                    <textarea id="uraian" class="materialize-textarea" name="uraian"
                                        required><?php echo $row['uraian']; ?></textarea>
                                    <?php
