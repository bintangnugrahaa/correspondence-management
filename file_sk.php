    ...
    <ul class="collapsible white" data-collapsible="accordion">
        <li>
            <div class="collapsible-header white">
                ...
                <span class="add">Tampilkan detail data surat keluar</span>
            </div>
...
function getSuratDetailsTable($suratData)
{
    $details = [
        ...
        'Tujuan Surat' => htmlspecialchars($suratData['tujuan']),
...
function getFileDisplay($suratData)
{
    ...
    $fileInfo = sk_getFileInfo($suratData['file']);
 ...
 */
function sk_getFileInfo($filename)
{
...
function getImageDisplay($suratData)
{
    return '
    <img class="gbr" 
         data-caption="' . date('d M Y', strtotime($suratData['tgl_catat'])) . '" 
         src="./upload/surat_keluar/' . htmlspecialchars($suratData['file']) . '"/>';
}
                ...
                <div class="col s9 left">
                    <div class="card">
                        <div class="card-content">
                            <p>File lampiran surat keluar ini bertipe <strong>' . $fileTypeText . '</strong>, silakan klik link dibawah ini untuk melihat file lampiran tersebut.</p>
                        </div>
                        <div class="card-action">
                            <strong>Lihat file :</strong> 
                            <a class="blue-text" href="./upload/surat_keluar/' . htmlspecialchars($suratData['file']) . '" target="_blank">
