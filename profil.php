    ...
    if (isset($_REQUEST['sub'])) {
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=pro&sub=pass" class="judul"><i
                                            class="material-icons">mode_edit</i> Edit Profil</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <form class="col s12" method="post" action="?page=pro&sub=pass">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <small class="red-text">*Setelah menekan tombol "Simpan", Anda akan diminta melakukan Login
                                ulang.</small>
                        </div>
                    </div>
                    <!-- Row in form END -->
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=pro" class="btn-large deep-orange waves-effect waves-light">BATAL <i
        ...
        <div class="row">
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">person</i>
                                    Profil User</a></li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="post" action="save.php">
                ...
                <div class="row">
                    <div class="col m12">
                        <a href="?page=pro&sub=pass" class="btn-large blue waves-effect waves-light">EDIT PROFIL<i
